...
<html lang="pt-br">
	...
	<center>
		<form method="POST" action="proc_edit_usuario.php">
			...
			<input style="border-radius: 10px; color: black; padding: 12px 25px; font-size: 15px" type="text" name="password" placeholder="Edite a senha do usuário" value="<?php echo $row_usuario['password']; ?>"><br><br>
			</div>
